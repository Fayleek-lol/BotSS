...
bot = telebot.TeleBot('1756217731:AAFJZYYU9GrQezzgSrHCHOdZ1hvW0Cg5Zo')
...
def send_text(message):
    if message.text == "Привет":
        ...
        bot.send_message(message.from_user.id,
                         "«Вояджер» — название двух американских космических зондов, запущенных в 1977"
                         "году, а также проекта по исследованию дальних планет "
                         "Солнечной системы с участием аппаратов данной серии."
                         "Всего было создано и отправлено в космос два аппарата серии «Вояджер»:"
                         " «Вояджер-1» и «Вояджер-2»."
                         " Аппараты были созданы в"
                         "Лаборатории реактивного движения НАСА."
                         " Проект считается одним из самых успешных и результативных в истории межпланетных"
                         "исследований — оба «Вояджера». впервые передали качественные снимки Юпитера и Сатурна,"
                         " а «Вояджер-2» впервые достиг Урана и Нептуна.")
