...
def send_text(message):
    if message.text == "Привет":
        ...
        sti = open('СолнечнаяСистема2.jpg', 'rb')
        bot.send_sticker(message.chat.id, sti)
        ...
        sti = open('МКС.jpg', 'rb')
        bot.send_sticker(message.chat.id, sti)
    elif message.text == "Солнце":
        bot.send_message(message.from_user.id,
                         "Солнце — одна из звёзд нашей Галактики (Млечный Путь)"
                         "и единственная звезда Солнечной системы. Вокруг Солнца обращаются"
                         "другие объекты этой системы: планеты и их спутники, карликовые планеты"
                         "и их спутники, астероиды, метеороиды, кометы и космическая пыль.")
        sti = open('Солнце.jpg', 'rb')
        bot.send_sticker(message.chat.id, sti)
    elif message.text == "Спутники":
        bot.send_message(message.from_user.id,
                         "Искусственный спутник Земли — космический летательный аппарат, "
                         "Вращающийся вокруг Земли по геоцентрической орбите."
                         "Спутники разделяют на несколько типов:"
                         "Астрономические спутники — спутники, предназначенные для исследования планет"
                         "Биоспутники —спутники,предназначенные для проведения экспериментов над организмами в космосе"
                         "Cпутники дистанционного зондирования Земли"
                         "Военный спутник — разведывательные спутники."
                         "Спутники связи"
                         "Космические корабли — пилотируемые космические аппараты"
                         "Орбитальные станции — долговременные космические корабли"
                         "Голоспутники - новейшие спутники предназначенные для исследования других планет.")
        sti = open('спутник.jpg', 'rb')
        bot.send_sticker(message.chat.id, sti)
    elif message.text == "Вояджер":
        bot.send_message(message.from_user.id,
                        "«Во́яджер» — название двух американских космических зондов, запущенных в 1977"
                        "году, а также проекта по исследованию дальних планет Солнечной системы с участием аппаратов данной серии."
                        "Всего было создано и отправлено в космос два аппарата серии «Вояджер»: «Вояджер-1» и «Вояджер-2». Аппараты были созданы в"
                        "Лаборатории реактивного движения НАСА. Проект считается одним из самых успешных и результативных в истории межпланетных"
                        "исследований — оба «Вояджера». впервые передали качественные снимки Юпитера и Сатурна, а «Вояджер-2» впервые достиг Урана и Нептуна.")
        sti = open('Вояджер.jpg', 'rb')
        bot.send_sticker(message.chat.id, sti)
    else:
